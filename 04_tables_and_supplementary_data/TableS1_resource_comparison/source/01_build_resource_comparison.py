...
ROWS = [
    [
        ...
        "Defines 54 adult human cortical gene programs and relates each to cell preference, area, laminar context, tissue neighborhood, and cross-species projection.",
    ...
    [
        ...
        "Spatial organization is not generally organized around one fixed program basis defined from nuclei and carried through matched tissue.",
    ...
    [
        ...
        "Tests macaque and mouse projection, conservation, and divergence in a fixed human program basis.",
        "Covered by the cited public source studies.",
    ],
    [
    ...
    [
        ...
        "The focus is developmental or compendium-level projection rather than an all-major-cell-class adult human cortical fixed-program resource with matched spatial projection.",
