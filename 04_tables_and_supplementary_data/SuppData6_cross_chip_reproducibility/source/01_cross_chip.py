...
PROGS = [
    ...
    ("program_5",  "P5 L2/3-IT (LINC00507)",      "EX"),    # superficial GM
    ("program_8",  "P8 L4/5-IT RORB",             "EX"),    # mid GM
    ("program_34", "P34 L6-IT / activity-IEG",    "EX"),    # deep GM + functional
    # --- inhibitory subclasses ---
    ("program_7",  "P7 PVALB interneuron",        "INH"),
    ("program_20", "P20 SST interneuron",         "INH"),
    ("program_29", "P29 LAMP5 interneuron*",      "INH"),
    # --- oligo / OPC ---
    ("program_37", "P37 Oligodendrocyte/myelin",  "OLIGO"), # WM-enriched, top score
    ("program_43", "P43 OPC / ECM proteoglycan",  "OPC"),
    # --- astrocyte ---
    ("program_15", "P15 Astrocyte Glu transport", "AST"),
    ("program_51", "P51 Reactive astro/vascular", "AST"),
    ("program_53", "P53 Astrocyte metal homeost.","AST"),
    # --- microglia ---
    ("program_40", "P40 Microglial activation",   "MG"),
    ("program_54", "P54 Microglial complement/MHC","MG"),
    # --- endothelial / vascular ---
    ("program_56", "P56 Blood vessel morphog.",   "ENDO"),
]
...
for chip in CHIP_IDS:
    ...
    chip_dims[chip] = (xy[:,0].ptp(), xy[:,1].ptp())
...
# ===== 5) save =====
pdf = f"{OUT_DIR}/ed_fig1_cross_chip_atlas_current.pdf"
png = f"{OUT_DIR}/ed_fig1_cross_chip_atlas_current.png"
