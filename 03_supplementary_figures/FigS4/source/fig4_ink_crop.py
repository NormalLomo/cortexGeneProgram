...
# sibling pointed at figures/fig4/svg_panels and looping "abcdefgh").
# For each panel SVG (figures/fig4/svg_panels/fig4_{a..h}.svg):
...
SVGD = os.path.join(PROJ, "figures/fig4/svg_panels")
...
def crop_one(pid):
    svg_path = os.path.join(SVGD, f"fig4_{pid}.svg")
