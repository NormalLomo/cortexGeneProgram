...
LOAD = str(PROJECT_ROOT / 'results/cnmf_snrna_joint_full1M_v1/snrna_joint_full1M_v1_k60_factor_loadings.tsv')
...
GENEINFO = str(PROJECT_ROOT / 'inputs/geneInfo_snRNA.csv')
...
SUB = {'AST': ('Astro', 'glia'), 'CHANDELIER': ('Chandelier', 'inh'), 'ENDO': ('Endothelial', 'vascular'), 'ET': ('L5-ET', 'exc'), 'L2-L3 IT LINC00507': ('L2/3-IT', 'exc'), 'L3-L4 IT RORB': ('L3/4-IT', 'exc'), 'L4-L5 IT RORB': ('L4/5-IT', 'exc'), 'L6 CAR3': ('L6-CAR3', 'exc'), 'L6 CT': ('L6-CT', 'exc'), 'L6 IT': ('L6-IT', 'exc'), 'L6B': ('L6b', 'exc'), 'LAMP5': ('LAMP5-IN', 'inh'), 'MICRO': ('Microglia', 'nonneuron'), 'NDNF': ('NDNF-IN', 'inh'), 'NP': ('L5/6-NP', 'exc'), 'OLIGO': ('Oligo', 'glia'), 'OPC': ('OPC', 'glia'), 'PAX6': ('PAX6-IN', 'inh'), 'PVALB': ('PVALB-IN', 'inh'), 'SST': ('SST-IN', 'inh'), 'VIP': ('VIP-IN', 'inh'), 'VLMC': ('VLMC', 'vascular')}
FUNC = [('Myelin', {'MOBP', 'PLP1', 'MBP', 'MAG', 'MOG', 'CLDN11', 'CNP', 'MYRF', 'OPALIN', 'ASPA'}), ('Astro', {'AQP4', 'GFAP', 'SLC1A2', 'SLC1A3', 'GJA1', 'ALDH1L1', 'FGFR3'}), ('Microglia', {'CX3CR1', 'P2RY12', 'CSF1R', 'C1QA', 'C1QB', 'C1QC', 'AIF1', 'CTSS', 'TYROBP', 'ITGAM'}), ('Vascular-BBB', {'CLDN5', 'FLT1', 'PECAM1', 'VWF', 'CLEC14A', 'A2M', 'ABCB1', 'EPAS1'}), ('Mural-VLMC', {'DCN', 'COL1A1', 'COL1A2', 'PDGFRB', 'RGS5', 'ACTA2', 'TAGLN', 'COL3A1', 'LUM', 'PTGDS'}), ('OPC', {'PDGFRA', 'CSPG4', 'OLIG1', 'OLIG2', 'SOX10', 'LHFPL3', 'PCDH15'}), ('Mito-ubiq', {'MT-CO1', 'MT-CO2', 'MT-CO3', 'MT-ND1', 'MT-ND2', 'MT-ND3', 'MT-ND4', 'MT-ATP6', 'MT-CYB', 'MTRNR2L12'}), ('Ribosomal', {'RPL13', 'RPS18', 'RPL10', 'RPS27', 'RPL41', 'RPS6', 'RPL3', 'RPLP1', 'RPS2', 'RPS3'}), ('Synaptic', {'SYT1', 'SNAP25', 'GRIN1', 'GRIN2B', 'DLG2', 'NRXN1', 'NRXN3', 'NLGN1', 'CAMK2A', 'GRIA1', 'SYN1'}), ('HeatShock', {'HSPA1A', 'HSPA1B', 'DNAJB1', 'HSPH1', 'FOS', 'JUN', 'EGR1', 'ARC', 'NR4A1'})]
...
for prog in [str(i) for i in range(1, 61)]:
    ...
    if ftag and fhits >= 2 and (ftag in ('Myelin', 'Astro', 'Microglia', 'Vascular-BBB', 'Mural-VLMC', 'OPC')):
        ...
        name = f'{sub_label} ({sg})'
    rows.append({'program': f'P{int(prog):02d}', '_pnum': int(prog), 'dominant_subclass': dom, 'subclass_specificity': spec, 'class': klass, 'top5_genes': ','.join(tg[:5]), 'spatial_top_celltype': spatial_top.get(prog, 'NA'), 'variable_stable': var_map.get(prog, 'NA'), '_base_name': name, 'notable_lncRNA_or_flag': ','.join(lflags) if lflags else '', '_eta2': round(float(eta2_map.get(prog, np.nan)), 4)})
...
out_cols = ['program', 'dominant_subclass', 'subclass_specificity', 'class', 'top5_genes', 'spatial_top_celltype', 'variable_stable', 'proposed_name', 'notable_lncRNA_or_flag']
