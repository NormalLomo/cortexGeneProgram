#!/usr/bin/env python
"""Ink-crop panelA_complexhm_v6.svg to a tight bbox (v12).
...
SRC = f"{FIG}/panels/panelA_complexhm_v10.svg"
OUT = f"{FIG}/panels/panelA_complexhm_v10_crop.svg"
RSVG = "rsvg-convert"
DPI = 300
