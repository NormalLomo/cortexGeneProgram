#!/usr/bin/env python3
"""Worker candidate compose for Fig10_v2.

Defaults stay on the submitted true-chain geometry, but panel directory and
output SVG can be overridden so a candidate can be rendered without touching
canonical files.
"""
import os
import re
...
OUT = os.environ.get("FIG10_OUT_SVG", f"{BASE}/Fig10_v2_restored.svg")
