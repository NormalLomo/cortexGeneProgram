...
# sibling pointed at scripts/figmarkcorr_B/svg_panels and looping "abcdefghijkl").
# For each panel SVG (scripts/figmarkcorr_B/svg_panels/figB_{a..h}.svg):
...
SVGD = os.path.join(PROJ, "scripts/figmarkcorr_B/svg_panels")
...
def crop_one(pid):
    svg_path = os.path.join(SVGD, f"figB_{pid}.svg")
