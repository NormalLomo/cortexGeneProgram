...
BASE = (__import__("os").environ["CORTEX_PROGRAM_ROOT"] + "/results/crossregion_v1")
LOAD = (__import__("os").environ["CORTEX_PROGRAM_ROOT"] + "/results/cnmf_snrna_joint_full1M_v1/snrna_joint_full1M_v1_k60_factor_loadings.tsv")
...
GENEINFO = (__import__("os").environ["CORTEX_PROGRAM_ROOT"] + "/inputs/geneInfo_snRNA.csv")
