...
IN = (__import__("os").environ["CORTEX_PROGRAM_ROOT"] + "/results/crossregion_v1/program_annotation_gobp.tsv")
OUT = (__import__("os").environ["CORTEX_PROGRAM_ROOT"] + "/results/crossregion_v1/program_names.tsv")
FDR_CUT = 0.25
