...
if (!nzchar(Sys.getenv("NMF_CODE_ROOT"))) stop("Set NMF_CODE_ROOT; original source directories must remain read-only.")
...
# =====================================================================
source(file.path(Sys.getenv("NMF_CODE_ROOT"), "07_figures_and_tables/within_subclass_S7/fig4_theme.R"))
suppressMessages({
...
OUT  <- paste0(Sys.getenv("CORTEX_PROGRAM_ROOT"), "/figures/fig4")
