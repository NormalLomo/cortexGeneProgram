...
work=(__import__("os").environ["CORTEX_PROGRAM_ROOT"] + "/scripts/fig2/")
outd=(__import__("os").environ["CORTEX_PROGRAM_ROOT"] + "/figures/fig2/")
...
_nm=pd.read_csv((__import__("os").environ["CORTEX_PROGRAM_ROOT"] + "/results/crossregion_v1/program_names.tsv"), sep="\t")
def _mk_label(n):
