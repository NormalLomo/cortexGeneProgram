...
# ---------------------------------------------------------------------------
SP = os.environ["SCSLAT_SITE_PACKAGES"]
...
# Retain the integrated representation beside the panel embedding.
np.save(os.path.join(PROJ, "figures/fig1/_intermediate/dpca_embedding.npy"), dpca)
